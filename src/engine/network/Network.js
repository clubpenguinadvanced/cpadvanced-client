...
export default class Network {
    ...
    connectGame(world, username, key) {
        ...
        this.connect(world, () => {
            this.send('', 'game_auth', response)
    ...
    send(key, action, args = {}) {
		let messagedata = JSON.stringify({ key: key, action: action, args: args })
